...
class Chassis {
     ...
     */
    void moveToPose(Pose itarget, double turnVel, vector<Pose> cutoffDists, vector<MotionLimit> imaxes, vector<double> iends, PIDValues turnPID = {0, 0, 0, 0}, bool reverse = false);
